...
![[obsidian-graph-zoomed-out.png|Graph of all notes in my Obsidian and their connections]]
...
![[obsidian-graph-screenshot-black-swan.png|Highlighting notes for a book, helping spaced-repetition in a fun way]]
...
If you're interested in setting up this combination with Jekyll and Obsidian, I've written a [[jekyll-and-obsidian-blogging|super technical guide on how to setup Obsidian for publishing on Github and Jekyll]].